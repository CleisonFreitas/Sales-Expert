        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Register Painel:</h6>
                        <a class="collapse-item" href="{{ route('company') }}">
                          <i class="fas fa-building mx-2"></i><span>Company</span>
                        </a>
                        <a class="collapse-item" href="{{ route('employer') }}">
                          <i class="fas fa-handshake mx-2"></i><span>Employer</span>
                        </a>
                        <a class="collapse-item" href="{{ route('supplier') }}">
                            <i class="fas fa-store mx-2"></i><span>Suppliers</span>
                        </a>
                        <a class="collapse-item" href="{{ route('payment') }}">
                            <i class="far fa-money-bill-alt mx-2"></i>
                            Payment Forms
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Customers Registers:</h6>
                ...
                <nav class="navbar navbar-expand navbar-light bg-light topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle bg-gradient-danger" href="#" id="userDropdown" role="button"
