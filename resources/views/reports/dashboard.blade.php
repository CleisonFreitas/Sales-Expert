...
@section('content')
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('dashboard_pdf') }}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Aniversariantes(Dia)
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
