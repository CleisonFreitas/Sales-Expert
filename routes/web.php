...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('customers_service/customer/{id}',               [CustomerServiceController::class, 'shop'])->name('customer_shop')->middleware(['auth']);
    Route::post('customers_service/create',                     [CustomerServiceController::class, 'store'])->name('service_create')->middleware(['auth']);
